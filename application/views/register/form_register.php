						...
						<div class="col-md-12">
							...
							<?= form_open('register') ?>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="ralamat" value="<?= set_value('ralamat') ?>">
                                </div>
                                <div class="form-group">
                                    <label for="telepon">No Telepon : </label>
                                    <input type="text" class="form-control" name="rtelepon" value="<?= set_value('rtelepon') ?>">
                                </div>
                                <div class="form-group">
                                    <label for="email">E-mail : </label>
                                    <input type="text" class="form-control" name="remail" value="<?= set_value('remail') ?>">
                                </div>
								<div class="form-group">
